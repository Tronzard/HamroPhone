...
export default function Footer() {
  return (
    <footer className="relative w-full bg-[#050505] text-white/70 border-t border-white/10 pt-20 pb-10 flex flex-col justify-between snap-start">
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
        ...
        <div className="flex flex-col gap-6">
          ...
          <nav className="flex flex-col gap-3 text-sm">
            <Link href="/buy" className="hover:text-[#00E5FF] transition-colors w-fit">Browse Phones</Link>
