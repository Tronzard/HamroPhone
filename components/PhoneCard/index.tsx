...
import { Battery, HardDrive, MemoryStick, Calendar, Monitor } from "lucide-react";
    ...
    >
      ...
      <div className="p-5 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between mt-auto pt-2 border-t border-white/8">
          ...
          <button className="px-4 py-2 rounded-xl bg-[#00E5FF]/10 text-[#00E5FF] text-sm font-semibold border border-[#00E5FF]/20 hover:bg-[#00E5FF]/20 transition-colors">
            View Details
          </button>
        </div>
      </div>
